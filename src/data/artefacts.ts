...
export const artefacts: Artefact[] = [
  ...
  { name: 'Scrimshaw Charm', slug: 'scrimshaw-charm', effect: 'Stances with STRENGTH cannot be weakened.', upgradedEffect: 'Stances cannot be weakened.', image: '/images/artefacts/scrimshaw-charm.png', inDemo: false },
  ...
  { name: 'Stiletto', slug: 'stiletto', effect: 'All attacks are PIERCING when SECONDARY is STANCELESS.', upgradedEffect: 'All attacks are PIERCING when SECONDARY has an empty PARRY METER.', image: '/images/artefacts/stiletto.png', inDemo: false },
